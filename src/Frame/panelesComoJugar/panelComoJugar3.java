...
public class panelComoJugar3 extends javax.swing.JPanel {

  
    public panelComoJugar3() {
        initComponents();
        setLocation(0, 80);
        setSize(550, 254);
        establecerElementos();
    ...
    private void establecerElementos(){
        ...
        titulo.setText("Cómo configurar una partida");
        ...
        textoGeneral.setText("<html><ul><li><b>Numero de jugadores.</b><br>Selecciona entre las opciones, de 2 a 4 jugadores.</li>"
                + "<li><b>Casillas en el tablero.</b><br>El tablero cuenta con distintos tamaños, ¡elige el de tu preferencia!.</li>"
                + "<li><b>Monto de gemas (Apuesta).</b><br>Escoge el monto de gemas con el que va a iniciar cada jugador.</li>"
                + "<li><b>Casillas</b><br>Existen 4 tipos de casillas: Centrales, normales, <br>semicirculares y triangulares.</li></ul></html>");
