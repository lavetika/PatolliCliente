...
public class panelComoJugar1 extends javax.swing.JPanel {

    public panelComoJugar1() {
        initComponents();
        setLocation(0, 80);
        setSize(550, 254);
        establecerElementos();
      ...
      private void establecerElementos(){
        ...
        titulo.setText("¿Que es Patolli?");
        titulo.setVisible(true);
        this.add(titulo);

        JLabel textoGeneral = new JLabel();
        textoGeneral.setSize(350, 250);
        textoGeneral.setLocation(180, -20);
        textoGeneral.setFont(new Font("PT Sans", Font.PLAIN, 14));
        textoGeneral.setForeground(new Color(243, 243, 220));
        textoGeneral.setText("<html>El Patolli es un antiguo juego mesoamericano de azar y apuestas.<br>"
                + "Fue practicado por teotihuacanos, toltecas, mayas, aztecas y el resto "
                + "de los pueblos conquistados por los<br>grandes imperios.</html>");
